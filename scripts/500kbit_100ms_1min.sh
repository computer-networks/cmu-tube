...
echo "=== (500kbit, 100ms, 1min) profile ==="
...
toxiproxy-cli create --listen 0.0.0.0:9003 --upstream localhost:15441 video || {
...
toxiproxy-cli toxic add --upstream   --type bandwidth --attribute rate=62 video 
...
pkill -9 -f toxiproxy || true
echo "=== (500kbit, 100ms, 1min) finished ==="
