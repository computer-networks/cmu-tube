...
echo "=== (1Mbps ↔ 5Mbps alternating every 10s, 100ms latency, 60s total) profile ==="
...
toxiproxy-cli create --listen 0.0.0.0:9007 --upstream localhost:15441 video || {
...
toxiproxy-cli toxic add --upstream   --type bandwidth --attribute rate=125 video   # 1 Mbps ≈ 125 KB/s
toxiproxy-cli toxic add --downstream --type bandwidth --attribute rate=125 video  # 1 Mbps ≈ 125 KB/s
...
pkill -9 -f toxiproxy || true
echo "=== (1Mbps ↔ 5Mbps alternating every 10s, 100ms latency, 60s total) finished ==="
