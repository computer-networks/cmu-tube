...
toxiproxy-cli create --listen 0.0.0.0:9010 --upstream localhost:15441 video || {
...
toxiproxy-cli toxic add --upstream   --type bandwidth --attribute rate=375 video # 3 Mbit/s = 375 KB/s
toxiproxy-cli toxic add --downstream --type bandwidth --attribute rate=375 video # 3 Mbit/s = 375 KB/s
...
pkill -9 -f toxiproxy || true
echo "=== (3mbit, 100ms, 1min) finished ==="
