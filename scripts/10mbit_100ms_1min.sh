...
echo "=== (10mbit, 100ms, 1min) profile ==="
...
toxiproxy-cli create --listen 0.0.0.0:9004 --upstream localhost:15441 video || {
...
toxiproxy-cli toxic add --upstream   --type bandwidth --attribute rate=1250 video # 10 Mbit/s = 1250 KB/s
toxiproxy-cli toxic add --downstream --type bandwidth --attribute rate=1250 video # 10 Mbit/s = 1250 KB/s
...
# sudo iftop -i lo -nNP -f "port 9004"
sleep 65
...
pkill -9 -f toxiproxy || true
echo "=== (10mbit, 100ms, 1min) finished ==="
